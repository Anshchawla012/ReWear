...
<body>
  <div class="container">
    <div class="gallery">
      <img src="lehenga1.jpg" alt="Lehenga">
      <img src="lehenga2.jpg" alt="Lehenga">
      <img src="lehenga3.jpg" alt="Lehenga">
      <img src="lehenga4.jpg" alt="Lehenga">
      <img src="lehenga5.jpg" alt="Lehenga">
    </div>

    <div class="info">
      <h2>Lehenga</h2>
      <p><strong>Description:</strong> Designer lehenga set with heavy work, perfect for weddings. Worn once, in mint condition with no flaws.</p>
      <p><strong>Category:</strong> Female</p>
      <p><strong>Size:</strong> XL</p>
      <p><strong>Condition:</strong> Very Good</p>
      <p><strong>Tags:</strong> <span class="tag">ethnic</span><span class="tag">cotton</span><span class="tag">kurti</span></p>
    ...
    <div id="purchaseModal" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.6); z-index:999;">
      <div style="background:#fff; padding:30px; max-width:400px; margin:100px auto; border-radius:12px; position:relative;">
        ...
        <button>
          <a href="payment-page.html">SUBMIT</a>
        </button>
    ...
    <div class="uploader">
      <p><strong>Uploaded by:</strong> Sonu Yadav</p>
      <p><strong>Location:</strong> Kota</p>
    </div>
  </div>
