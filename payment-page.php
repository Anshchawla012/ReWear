...
<head>
  <meta charset="UTF-8" />
  <title>ReWear | Item Purchase</title>
...
<body>
  <div class="container">
    <h2>Buy your beautiful Product just in (₹499)</h2>
  ...
  <script>
    document.getElementById('payNow').addEventListener('click', function (e) {
      var options = {
        "key": "rzp_test_1DP5mmOlF5G5ag", // ✅ Razorpay's official demo test key
        "amount": 49900, // ₹499 in paise
        "currency": "INR",
        "name": "ReWear",
        "description": "Red Kurti Purchase",
