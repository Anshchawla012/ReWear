...
<body>
  <div class="container">
    <div class="gallery">
      ...
      <img src="top2.jpg" alt="top">
      <img src="top4.jpg" alt="top">
      <img src="top5.jpg" alt="top">
    </div>

    <div class="info">
      <h2>Top</h2>
      <p><strong>Description:</strong> Blue stretchable denim jeans for daily wear. Minimal fading, fits perfectly and very comfy.</p>
      <p><strong>Category:</strong> Female</p>
      <p><strong>Size:</strong> M</p>
      <p><strong>Condition:</strong> Very Good</p>
      <p><strong>Tags:</strong> <span class="tag">ethnic</span><span class="tag">cotton</span><span class="tag">top</span></p>
    ...
    <div class="uploader">
      <p><strong>Uploaded by:</strong> Sonam Pawar</p>
